...
class Cancelar2(private val activity: Activity) {
    private val inflater = activity.getSystemService(LAYOUT_INFLATER_SERVICE) as LayoutInflater
    private val popupView = inflater.inflate(R.layout.activity_cancelar2, null)   // actividad del pop up
    ...
    fun showPopupWindowCancelar(view: View) {
        ...
        buttonSi.setOnClickListener {
            val intent = Intent(activity, CodigoRescatista::class.java)
